...
<body>
                <div class="testbox">
                    ...
                    <form:form action="loginprocesing" method="post">
                        <hr>
                        <label id="icon" for="loginusername"><i class="icon-user"></i></label>
                        <input type="text" name="username" id="loginusername"
                               placeholder="Логін" required/>
                        <label id="icon" for="loginpassword"><i class="icon-shield"></i></label>
                        ...
                        <table>
                            ...
                            <tr height="50px">
                                <td><a href="register">Ви тут вперше?</a></td>
                            </tr>
                        </table>
                    </form:form>
                </div>
