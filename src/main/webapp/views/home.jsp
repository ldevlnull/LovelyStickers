...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/styleFooter_Header">
    <script type="text/javascript" src="js/functionalFooter_Header"></script>
    <script>
        function resendLink() {
            ...
            <section class="content">
                <div class="login-page">
                    <div class="form">
                        ...
                        <p>Ви маєте активувати вашу сторінку за допомогою листа, що був надісланний на вашу електронну
                            адресу</p>
                        <p id="ResendLinkText">
